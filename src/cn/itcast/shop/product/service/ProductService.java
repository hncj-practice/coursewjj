...
public class ProductService {
	...
	public List<Product> findLike() {
		return productDao.findLike();
	}
	
	
	// 首页上限时商品的查询
		public List<Product> findxs() {
			return productDao.findxs();
		}
		// 首页上排行商品的查询
		public List<Product> findph() {
			return productDao.findph();
		}
		public List<Product> findrq() {
			return productDao.findrq();
		}
		public List<Product> findbox1() {
			return productDao.findbox1();
		}
		public List<Product> findbox2() {
			return productDao.findbox2();
		}
		public List<Product> findbox3() {
			return productDao.findbox3();
		}
		public List<Product> findbox4() {
			return productDao.findbox4();
		}
