        ...
        <div class="login_form">
            ...
            <div class="login_title ">
                <div class="login_name clearfix">
                    ...
                    <input type="text" id="username" name="username" maxlength="20"  placeholder="用户名" class="name1">
                </div>
                <br />
            ...
            <div class="autologin">
                <div class="autologin1">
                      <a href="${ pageContext.request.contextPath }/admin/index.jsp" style="color: #f26b11; font-style: 16px;">
                        管理员登录
                    </a> 
                </div>
                <div class="autologin2">
                     <a href="${ pageContext.request.contextPath }/user_registPage.action" style="color: #f26b11; font-style: 16px;">
                        立即注册
                    </a>  
                </div>
            </div>
