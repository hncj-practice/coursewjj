...
<div class="container cart" align="center" style="width: 500px;height: 200px;">
	...
	<h3>恭喜您，支付成功啦！</h3>
	<br>
	<font style="font-size:16px">支付方式：<span style="color:red">在线支付</span></font>
	<br>
	<br>
	<div style="width: 200px;height: 30px;">
	<a href="${pageContext.request.contextPath }/index.action"><font style="font-size:20px;color:red;">继续购物</font></a>
	</div>
	</div>
</div>
